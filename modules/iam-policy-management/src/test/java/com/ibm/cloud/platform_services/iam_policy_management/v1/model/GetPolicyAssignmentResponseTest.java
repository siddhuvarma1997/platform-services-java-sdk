...
/**
 * Unit test class for the GetPolicyAssignmentResponse model.
 */
public class GetPolicyAssignmentResponseTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  // TODO: Add tests for models that are abstract
  @Test
  public void testGetPolicyAssignmentResponse() throws Throwable {
    GetPolicyAssignmentResponse getPolicyAssignmentResponseModel = new GetPolicyAssignmentResponse();
    assertNotNull(getPolicyAssignmentResponseModel);
  }
}